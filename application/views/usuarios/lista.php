    ...
    <div class="mainbody-section">
        ...
        <div class="container" style="width:90%;">
            <div class="row">
                ...
                <button role="button" class="btn btn-danger" style="font-weight: bold;font-size: 13px; color: white " id="enviar"  >
              ...
              <h3 id="tables">Listado de Usuarios</h3>
            </div>
                        ...
                        <tr style="font-size: 16px;text-align: center">
                           ...
                           <?php if ($usuario->estatus == 't'): ?>
                            ...
                            <td style='text-align: center'>
                                <a href="<?php echo base_url()?>index.php/usuarios/usuarios/editar/<?= $usuario->id; ?>"><i class="fa fa-pencil"></i></a>
                            </td>
                            <td style='text-align: center'>
                                <?php if ($usuario->estatus == 't') {?>
