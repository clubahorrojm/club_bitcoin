    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Monto mínimo para retiros</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Actualizar Monto mínimo para retiros</h3>
                            ...
                            <form id="form_cargo">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="300" maxlength="6" id="monto_retiro_minimo" name="monto_retiro_minimo" value="<?php echo $editar->monto_retiro_minimo; ?>" class="form-control">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="form-group">
...
<script>
    $('#codigo').numeric();
    $('#monto_retiro_minimo').numeric({allow: "."});
    $('input').on({
        keypress: function () {
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#monto_retiro_minimo').val().trim() == '')) {
            bootbox.alert('Disculpe, debe colocar el monto mínimo de retiro', function () {
                $('#monto_retiro_minimo').parent('div').addClass('has-error');
            });
        } else {
            $.post('<?php echo base_url(); ?>index.php/configuracion/CRetiroMinimo/actualizar', $('#form_cargo').serialize(), function (response) {
				//~ alert(response);
                if (response == 'fallo') {
                    ...
                    bootbox.alert("Se actualizó con exito", function () {
                        ...
                        url = '<?php echo base_url(); ?>index.php/configuracion/CRetiroMinimo'
                        window.location = url
                    });
                }
