    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Registrar Cuenta</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Registro de Cuenta</h3>
                            ...
                            <form id="form_cuentas">
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autofocus="" id="codigo" value="<?php echo $ultimo_id +1 ?>" disabled="disabled" name="codigo"  class="form-control">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label style="font-weight:bold">Cuenta</label>
                                        <input type="text" placeholder="Introdúzca el número de la cuenta" maxlength="20" id="descripcion" name="descripcion"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="col-md-3">
                                    <div class="form-group">
...
<script>
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#descripcion').val().trim() == '')) {
            ...
            $.post('<?php echo base_url(); ?>index.php/configuracion/CCuentas/guardar', $('#form_cuentas').serialize(), function (response) {
                if (response[0] == '1') {
