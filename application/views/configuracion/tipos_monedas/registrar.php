    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Registrar Tipo de Moneda</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Registro de Tipo de Moneda</h3>
                            ...
                            <form id="form_bancos">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Introduzca el nombre de la moneda" maxlength="50" id="descripcion" name="descripcion"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label style="font-weight:bold">Símbolo</label>
                                        <input type="text" placeholder="Símbolo de la moneda" maxlength="10" id="abreviatura" name="abreviatura"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="form-group">
...
<script>
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#descripcion').val().trim() == '')) {
            ...
            $.post('<?php echo base_url(); ?>index.php/configuracion/CTiposMonedas/guardar', $('#form_bancos').serialize(), function (response) {
                if (response[0] == '1') {
