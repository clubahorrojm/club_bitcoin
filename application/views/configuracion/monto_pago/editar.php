                            ...
                            <form id="form_cargo">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="10.5" maxlength="50" id="monto_pago" name="monto_pago" value="<?php echo $editar->monto_pago; ?>" class="form-control">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="form-group">
...
<script>
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#monto_pago').val().trim() == '')) {
            bootbox.alert('Disculpe, debe colocar el porcentaje de cargo', function () {
                $('#monto_pago').parent('div').addClass('has-error');
            });
        } else {
            $.post('<?php echo base_url(); ?>index.php/configuracion/CMontoPago/actualizar', $('#form_cargo').serialize(), function (response) {
				//~ alert(response);
                if (response == 'fallo') {
                    ...
                    bootbox.alert("Se actualizó con exito", function () {
                        ...
                        url = '<?php echo base_url(); ?>index.php/configuracion/CMontoPago'
                        window.location = url
                    });
                }
