              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <table id="tab_bancos" class="table table-bordered table-striped">
				    ...
				    <td style='text-align: center'>
				       <a title="Editar" href="<?php echo base_url() ?>index.php/configuracion/CPaises/editar/<?= $bancos->id; ?>"><i class="fa fa-pencil text-orange"></i></a>
				    </td>
				    <td style='text-align: center'>
...
<div class="modal" id="myModal" role="dialog">
   ...
   $('.levantar').click(function(e){
	...
	//$('#myModal').modal('keyboard')
        $.post('<?php echo base_url(); ?>index.php/configuracion/CPaises/eliminar/' + id + '', function (response) {
	    if (response[0] == "e") {
	...
	url = '<?php echo base_url() ?>index.php/configuracion/CPaises/registrar';
	window.location = url;
    });
	...
	$("table#tab_bancos").on('ifChanged', 'input.activar_desactivar', function (e) {
		...
		bootbox.confirm("¿Desea "+accion+" este banco?", function(result) {
			if (result) {
				...
				$.post('<?php echo base_url(); ?>index.php/configuracion/CPaises/activar_desactivar/' + id, {'accion':accion}, function(response) {
