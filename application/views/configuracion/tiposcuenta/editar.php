    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Editar Tipo de Cuenta</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Editar Tipo de Cuenta <strong></strong></h3>
...
<script>
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#descripcion').val().trim() == '')) {
            ...
            $.post('<?php echo base_url(); ?>index.php/configuracion/CTiposCuenta/actualizar', $('#form_bancos').serialize(), function (response) {
                if (response[0] == '1') {
