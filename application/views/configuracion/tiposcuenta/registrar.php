    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li style="color:#3C8DBC">Tipos de Cuenta</li>
                <li class="active">Registrar Tipo de Cuenta</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Registro de Tipo de Cuenta</h3>
                            ...
                            <form id="form_bancos">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Introdúzca el nombre del tipo de cuenta" maxlength="50" id="descripcion" name="descripcion"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="form-group">
...
<script>
    ...
    $('#volver').click(function () {
        url = '<?php echo base_url() ?>index.php/configuracion/CTiposCuenta/'
        window.location = url
    })
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#descripcion').val().trim() == '')) {
            ...
            $.post('<?php echo base_url(); ?>index.php/configuracion/CTiposCuenta/guardar', $('#form_bancos').serialize(), function (response) {
                if (response[0] == '1') {
                    ...
                    bootbox.alert("Disculpe, este tipo de cuenta ya se encuentra registrado", function () {
                    }).on('hidden.bs.modal', function (event) {
                        $("#descripcion").parent('div').addClass('has-error')
                        $("#descripcion").focus();
                    });
