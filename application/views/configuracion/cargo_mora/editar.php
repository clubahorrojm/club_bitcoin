    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Cargo por Mora</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Actualizar Cargo por Mora</h3>
                            ...
                            <form id="form_cargo">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="10.5" maxlength="6" id="porcentaje_cargo" name="porcentaje_cargo" value="<?php echo $editar->porcentaje_cargo; ?>" class="form-control">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="form-group">
...
<script>
    $('#codigo').numeric();
    $('#porcentaje_cargo').numeric({allow: "."});
    $('input').on({
        keypress: function () {
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#porcentaje_cargo').val().trim() == '')) {
            bootbox.alert('Disculpe, debe colocar el porcentaje de cargo', function () {
                $('#porcentaje_cargo').parent('div').addClass('has-error');
            });
        } else {
            $.post('<?php echo base_url(); ?>index.php/configuracion/CCargoMora/actualizar', $('#form_cargo').serialize(), function (response) {
				//~ alert(response);
                if (response == 'fallo') {
                    bootbox.alert("Disculpe, no se pudo actualizar, consulte con su administrador", function () {
                    }).on('hidden.bs.modal', function (event) {
                        $("#porcentaje_cargo").parent('div').addClass('has-error')
                        $("#porcentaje_cargo").focus();
                    });
                }else {
                    bootbox.alert("Se actualizó con exito", function () {
                    }).on('hidden.bs.modal', function (event) {
                        url = '<?php echo base_url(); ?>index.php/configuracion/CCargoMora'
                        window.location = url
                    });
                }
