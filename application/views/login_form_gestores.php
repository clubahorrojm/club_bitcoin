				...
				<form id="frmlogin" class="form-horizontal"  method="POST" enctype="multipart/form-data" autocomplete="off" role="form">
					<div class="login-box">
						<div class="login-logo">
							<center>
								<img style="background-color: #c0c0c0; width: 75%"  id="logo_info" class="img-circle" src="<?= base_url() ?>static/img/circulo-01.png"/>
							</center>
						</div>
						<!-- /.login-logo -->
						<div class="login-box-body" style="background-color: #F2F2F2">
						  <h4 class="login-box-msg">Bienvenidos gestores y asesores</h4>
						  ...
						  <form action="../../index2.html" method="post">
							...
							<div class="input-group">
								...
								<input style="background-color: #22274b; width: 50%; color: #edd727; font-weight: bold "  type="hidden" id="type_user" name="type_user" value="GESTOR">
							...
							<div class="row">
							  ...
							  <!-- /.col -->
							  <div class="col-xs-4">
								<button type="submit" class="btn btn-warning btn-block btn-flat" id="submit" name="submit">Entrar</button>
							  </div>
							  <!-- /.col -->
							</div>
						  </form>
					  					  
						  <a href="#"><h5 class="text-danger">Olvide mi contraseña</h5></a><br>
