    ...
    <div class="content-wrapper" style="min-height: 1156px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li style="color:#3C8DBC">Administración</li>
                <li style="color:#3C8DBC">Paises</li>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color:#3C8DBC">Editar País <strong></strong></h3>
                            ...
                            <form id="form_paises">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Introduzca el nombre del país" maxlength="50" id="descripcion" value="<?php echo $editar[0]->descripcion ?>" name="descripcion"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div><!-- /.form-group -->
                                </div><!-- /.form-group -->
                                <div class="form-group">
...
<script>
    ...
    $('#volver').click(function () {
        url = '<?php echo base_url() ?>index.php/administracion/CPaises/'
        window.location = url
    })
    ...
    $("#registrar").click(function (e) {
        ...
        if (($('#descripcion').val().trim() == '')) {
            bootbox.alert('Disculpe, Debe Colocar el nombre del País', function () {
                $('#descripcion').parent('div').addClass('has-error');
            });
        } else {
            $('#codigo').prop('disabled',false);
            $.post('<?php echo base_url(); ?>index.php/administracion/CPaises/actualizar', $('#form_paises').serialize(), function (response) {
                if (response[0] == '1') {
                    ...
                    bootbox.alert("Disculpe, Esta país ya se encuentra registrado", function () {
                    }).on('hidden.bs.modal', function (event) {
                        $("#descripcion").parent('div').addClass('has-error')
                        $("#descripcion").focus();
                    });
                    ...
                    bootbox.alert("Se registro con exito", function () {
                        ...
                        url = '<?php echo base_url(); ?>index.php/configuracion/CPaises'
                        window.location = url
                    });
                }
