...
// Load database
        $this->load->model('configuracion/MPaises');
    ...
    function index()
    {
        ...
        $data['listar'] = '';
        $ultimo_id = $this->ModelsBusqueda->count_all_table('conf_paises');
        if ($ultimo_id > 0){
        ...
        $this->load->view('configuracion/paises/lista', $data);
    }

    function registrar()
    {
        $data['ultimo_id']   = $this->ModelsBusqueda->count_all_table('conf_paises');
        $this->load->view('configuracion/paises/registrar', $data);
    }
    ...
    function editar()
    {
        ...
        $this->load->view('configuracion/paises/editar', $data);
    }
