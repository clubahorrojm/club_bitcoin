...
/**
 * Description of ControllersLibroVentas
 *
 * @author jsolorzano
 */
...
// Load database
    ...
    function pdf_libroventas($desde,$hasta)
    {
        ...
        foreach($data['ventas'] as $factura){
			// Incluimos en la lista sólo los código de facturas del departamento de administración
			if(strpos($factura->codfactura, 'ADM') === false){
				$list_facturas .= "";
			}else{
