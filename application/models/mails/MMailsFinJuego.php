...
class MMailsFinJuego extends CI_Model {
    ...
    public function enviarMailConfirm($datos_mail) {
		...
		// título
		$título = 'Criptozone: notificaci&oacute;n de nuevo nivel alcanzado';
		...
		<html>
		  ...
		  <body class="" style="background-color:#f6f6f6;font-family:sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;line-height:1.4;margin:0;padding:0;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
			<table style="height:auto; background-image: url("http://app.criptozone.com/static/img/correo/ficha.jpg"); background-size: 100%; background-repeat: no-repeat" border="0" cellpadding="0" cellspacing="0" class="body" >
			  <tr>
				<td class="container" style="font-family:sans-serif;font-size:14px;vertical-align:top;display:block;max-width:580px;padding:10px;width:580px;height:800px;Margin:0 auto !important;">
				  <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
						  ...
						  <table border="0" cellpadding="0" cellspacing="0" style="backgroud-color:transparent; border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
							<tr>
							  <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
								<h2 style="font-size:15px;line-height:28px;margin:0 0 12px 0">Fin del juego.</h2>
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;text-align: justify;">
									Much&iacute;simas felicitaciones, lograste completar por completo tu matriz. Ahora tienes la posibilidad de retirar todas tus ganancias, haciendo la solicitud de retiro correspondiente en nuestra plataforma.
								</p>
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;text-align: justify;" >
									Recuerda, que si deseas volver a participar puedes hacerlo. S&oacute;lo debes completar el proceso de retiro y volver a registrarte.
								</p>
							  </td>
							</tr>
						  </table>
					...
					<a href="https:/instagram.com/criptozone/"><img src="http://app.criptozone.com/static/img/correo/instagram.png" style="width: 5%;Margin-top:100px;Margin-left:550px;" /><a/>
