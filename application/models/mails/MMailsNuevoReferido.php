...
class MMailsNuevoReferido extends CI_Model {
						  ...
						  <table border="0" cellpadding="0" cellspacing="0" style="backgroud-color:transparent; border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
							<tr>
							  <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
								<h2 style="font-size:15px;line-height:28px;margin:0 0 12px 0">Nuevo referido.</h2>
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Criptozone se complace en notificarle que otro invitado se ha agregado a su matriz.</p>
							  </td>
							</tr>
						  </table>
						</td>
