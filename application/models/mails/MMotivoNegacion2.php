...
class MMotivoNegacion2 extends CI_Model {
						  ...
						  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
							<tr>
							  <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
								...
								El presente es con la finalidad de notificarle que el registro de su pago ha sido denegado por nuestra plataforma, debido a que el monto transferido a nuestro wallet no se corresponde con el aporte inicial de $10 equivalente en bitcoin que se requieren de acuerdo a la fecha y monto registrados.
								</p>
								
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;text-align: justify;">
								Si desea puede comunicarse con nuestros operadores a través del chat de nuestra plataforma, quienes gentilmente le atenderán y podrán aclarar cualquier duda con referencia a su pago.
								</p>
								
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;text-align: justify;">
								Sin más a que hacer referencia, sino invitarle a comunicarse con nuestros operadores para solventar su situación, y agradecerle de antemano su disposición a participar en nuestra plataforma, queda de usted
								</p>
