...
class MRecBasico extends CI_Model {
    ...
    public function enviarMailClave($datos_reg) {
        // Varios destinatarios
		//~ $para = 'aidan@example.com' . ', '; // atención a la coma
		$para = $datos_reg['email'];

		// título
		$título = 'Criptozone: Contraseña actualizada';
						  ...
						  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
							<tr>
							  <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
								...
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Gracias por visitarnos</p>
								
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;text-align: justify;">Dando respuesta a tu solicitud, el cambio de clave de tu usuario se llevó a cabo con éxito...</p>
								...
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;text-align: justify;">Desde este momento puedes acceder a nuestra plataforma con tu nueva clave de acceso.</p>
