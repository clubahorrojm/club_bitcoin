...
class MMailsSoporteRespuesta extends CI_Model {
    ...
    public function enviarMailConfirm($datos_reg) {
		...
		// título
		$título = 'Criptozone: inquietud antendida por parte del equipo de soporte técnico de criptozone';
		// mensaje
		$mensaje = '
		<!DOCTYPE html>
		<html>
			  ...
			  <tr>
				<td class="container" style="font-family:sans-serif;font-size:14px;vertical-align:top;display:block;max-width:580px;padding:10px;width:580px;height:800px;Margin:0 auto !important;">
				  <div class="content" style="box-sizing:border-box;display:block;Margin:0 auto;max-width:580px;padding:10px;">
						  ...
						  <table border="0" cellpadding="0" cellspacing="0" style="backgroud-color:transparent; border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
							<tr>
							  <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
								<h2 style="font-size:15px;line-height:28px;margin:0 0 12px 0">Solicitud atendida.</h2>
								<p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">El equipo de Criptozone se complace en informarle que ya su solicitud de soporte ha sido atendida</p>
							  </td>
							</tr>
						  </table>
						</td>
					...
					<a href="https:/instagram.com/criptozone/"><img src="http://app.criptozone.com/static/img/correo/instagram.png" style="width: 5%;Margin-top:140px;Margin-left:550px;" /><a/>
